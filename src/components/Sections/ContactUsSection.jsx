        ...
        <div class="flex flex-wrap -mx-4 lg:justify-between">
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
              <h2 class="text-dark dark:text-white font-title mb-6 text-[25px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                GET IN TOUCH <span className="text-aqua">WITH US</span>
              </h2>
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="mb-1 font-title text-xl font-bold text-dark dark:text-white">
                    Address
                  </h4>
                  <p class="text-base text-body-color dark:text-dark-6">
                    <a
                      href="https://maps.app.goo.gl/j6Hgnioyc9kBpcaB8"
                      target="_blank"
                    >
                      Muslim Community Mosque 1818 N 32 ST. PHOENIX, AZ 85008
                    </a>
                  </p>
                </div>
              </div>
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  ...
                  <p class="text-base text-body-color dark:text-dark-6">
                    <a href="tel:+1 602 306 4959" target="_blank">
                      +1 602 306 4959
                    </a>
                  </p>
                </div>
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  ...
                  <p class="text-base text-body-color dark:text-dark-6">
                    <a href="mailto:info@mcmphoenix.com" target="_blank">
                      info@mcmphoenix.com
                    </a>
                  </p>
                </div>
